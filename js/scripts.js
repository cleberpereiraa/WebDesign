...
document.getElementById("service-next").onclick = function(){
  ...
  if (servico_atual == our_services.length - 1) {
    ...
    var seguinte = servico_atual + 1;
  }
document.getElementById("service-title").innerHTML = our_services[seguinte].title;
document.getElementById("service-text").innerHTML = our_services[seguinte].text;
servico_atual = seguinte;
};
...
//current_year
 ...
 //API Key Google: AIzaSyD20ZRtB1OOV2O9ym_r4M5WclRptwfC-3Y  